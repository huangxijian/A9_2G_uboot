...
#define IOX_BELL  IMX_GPIO_NR(1,4)   /* add by yaonz for bell */
#define IOX_HUAWEI_ME909S_3_8V   IMX_GPIO_NR(1,18)   /* add by yaonz for GaoDeWei HUAWEI_ME909S power 20180626 */
...
iomux_v3_cfg_t const uart1_pads[] = {
	MX6_PAD_SD3_DAT7__UART1_TX_DATA | MUX_PAD_CTRL(UART_PAD_CTRL),//yaonz 20170911
...
iomux_v3_cfg_t const usdhc3_pads[] = {
	...
	MX6_PAD_NANDF_D0__GPIO2_IO00    | MUX_PAD_CTRL(NO_PAD_CTRL), /* CD yaonz 20170911 */
};
...
#define USDHC3_CD_GPIO	IMX_GPIO_NR(2, 12) //yaonz
...
{
	/* add by yaonz for bell  */
	gpio_direction_output(IOX_BELL, 1);
	/*gpio_direction_output(IOX_HUAWEI_ME909S_3_8V, 0);*/
...
{
    /* add by yaonz for bell  */
	gpio_direction_output(IOX_BELL, 0);
...
#endif
gpio_direction_output(IMX_GPIO_NR(6, 14), 0);//huang
	return 0;
}
